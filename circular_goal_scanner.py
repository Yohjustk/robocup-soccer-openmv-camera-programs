...
radius_3 = 95 #中間円半径
angle_st = 45 #チェック開始角度
angle_st_const = angle_st
angle_end = 315 #チェック終了角度
...
while(True):
    ...
    #in case of the goal was detected /ゴールが見つかった場合
        ...
        #get the start and end goal's angles /ゴールの両端の角度を導出
        ...
        #draw lines to point out goal detection　and goal area /ゴールを検知したこととゴールエリアを示すために線を描く
